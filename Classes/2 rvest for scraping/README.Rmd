...
Overall, since Selenium have to synchs to a browser, is also slower than `rvest`.
...
Computer scientists seem to lack the capacity to explain what a regular expression is to a social scientist. Check the superca\*\*o\*a of Italian Wikipedia (translation in mine):
...
The most famous regular expression is `"."` within a string. It means: "anything that is not a new line (`"\n"`). So if one looks for `"a."`, is looking for `"ab"`,`"ac"`,`"ad"`,`"aò"`,`"aä"`,`"a?"`... anything that is not `a\n`.
